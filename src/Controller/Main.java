...
public class Main {
    ...
    public void init(){
        ...
        // Add sample history
        sqlite.addHistory("admin", "Antivirus", 1, 200.00, "2019-04-03 14:30:00.000");
        sqlite.addHistory("manager", "Firewall", 1, 200.00, "2019-04-03 14:30:01.000");
        sqlite.addHistory("staff", "Scanner", 1, 200.00, "2019-04-03 14:30:02.000");
...
//            System.out.println(" Password: " + users.get(nCtr).getHashedPassword());
